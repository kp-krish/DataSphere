...
export const GEOGRAPHY: readonly GeoEntry[] = [
  {
    ...
    region: 'West',
    cities: ['Seattle', 'Portland', 'San Francisco', 'Los Angeles', 'Phoenix', 'Denver'],
  },
  {
    country: 'United States',
    region: 'Northeast',
    cities: ['New York', 'Boston', 'Philadelphia', 'Pittsburgh'],
  },
  {
    country: 'United States',
    region: 'South',
    cities: ['Austin', 'Atlanta', 'Miami', 'Nashville', 'Dallas'],
  },
  {
    country: 'United States',
    region: 'Midwest',
...
export const MONTH_SEASONALITY = [
  0.78, 0.74, 0.92, 0.95, 1.02, 0.98, 0.94, 0.96, 1.06, 1.14, 1.48, 1.62,
] as const;
 ...
 */
export const WEEKDAY_SEASONALITY = [1.12, 1.15, 1.14, 1.1, 1.02, 0.62, 0.55] as const;
